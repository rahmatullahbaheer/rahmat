    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Resume — Rahmat Ullah Full Stack Developer",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Download resume of Rahmat Ullah — Next.js, React, Node.js, MongoDB, PostgreSQL, AI. 2+ years experience. Available for hire.",
    images: ["/og-image.jpg"],
  },
};
...
const skills = [
  ...
  {
    category: "Backend",
    items: ["Node.js", "Express.js", "REST APIs", "JWT", "NextAuth.js"],
  },
  { category: "Databases", items: ["MongoDB", "PostgreSQL", "MySQL", "SQL"] },
  { category: "Mobile", items: ["React Native", "Expo"] },
  {
    category: "Tools & DevOps",
    items: ["Git", "Vercel", "CI/CD", "Redux Toolkit"],
  },
  {
    category: "Integrations",
    items: ["OpenAI", "Stripe", "Socket.IO", "Agora", "Zoom SDK"],
  },
];
...
const experiences = [
  ...
  { company: "NausalTech", role: "MERN Stack Developer", period: "2022" },
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-12">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                Rawalpindi, Pakistan · baheer224@gmail.com
              </p>
            </div>
            <a
          ...
          <section className="bg-[#111827] border border-slate-800 rounded-2xl p-8 mb-8">
            ...
            <p className="text-slate-300 text-base leading-relaxed">
              ...
              web applications using the MERN stack and Next.js. Experienced in
              developing AI-powered features, real-time applications, video
              conferencing integrations, cross-platform mobile apps, and
              e-commerce platforms. Strong focus on clean code, performance, and
                ...
                <div key={group.category}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {group.items.map((skill) => (
                      <span
                        key={skill}
                        className="text-sm px-3 py-1 rounded-lg bg-slate-800 border border-slate-700 text-slate-300"
                      >
                        {skill}
                      </span>
                    ))}
          ...
          <div className="text-center">
            <p className="text-slate-400 text-sm mb-4">
              Get the complete resume with all project details
            </p>
            <a
              href="/rahmat_ullah.pdf"
              download
